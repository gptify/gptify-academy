...
const COURSE_DATA = {
  "1_1": {
    ...
    "storyboard": [
      ...
      },
      {
        ...
        "quote": "Frontier (Claude 3.7 / GPT-4o): B2B hujjatlar, marketing va tezkorlik.\nReasoning (o1 / o3-mini / DeepSeek-R1): Murakkab mantiq va hisob-kitob.\nUlkan Kontekst (Gemini 2.0): 1M-2M tokenlik qalin kitob va arxivlar.",
        "tip": "⚖️ <b>Doimiy Qoida (Evergreen):</b> Modelning versiya raqamiga emas, balki vazifangizga mos toifasiga (arxitipiga) qarab tanlang."
      },
      {
    ...
    "deepDive": "<div class=\"deep-dive-article\">\n  <div class=\"case-callout\">\n    <h4 style=\"color:var(--teal-light); margin-top:0;\">🎯 1-Qism: \"Next-Token Prediction\" Nima va Nega Model Inson Emas?</h4>\n    <p>\n      Ko'pchilik sun'iy intellektni xuddi Google kabi hamma narsani biluvchi internet-ensiklopediya deb o'ylaydi. Bu noto'g'ri! Katta Til Modellari (LLM — Large Language Models) aslida <b>navbatdagi eng ehtimolli tokenni (so'z yoki bo'g'inni) bashorat qiluvchi</b> ehtimollik kalkulyatoridir.\n    </p>\n    <p>\n      Masalan: <i>\"O'zbekistonning poytaxti — ...\"</i> jumlasi kiritilganda, model parametrlar bazasidan hisoblab, \"Toshkent\" so'zining ehtimolligi 99.4% deb topadi va uni chiqaradi. Agar siz modeldan u bilmaydigan noma'lum ichki hisobotingiz haqida so'rasangiz, u <i>\"bilmayman\"</i> deyish o'rniga, grammatik jihatdan eng ishonarli eshitiladigan <b>yolg'onni (hallucination)</b> to'qib chiqaradi.\n    </p>\n  </div>\n\n  <h4 style=\"color:var(--text); margin-top:20px;\">📊 2-Qism: Zamonaviy Modellarning 4 Ta Asosiy Toifasi (Evergreen Tanlov Matritsasi)</h4>\n  <p>Bozorda har 2-3 oyda yangi model chiqadi (GPT-4o, Claude 3.7 Sonnet, o1, o3-mini, Gemini 2.0, DeepSeek-R1). Har safar yangilanib adashmaslik uchun, professional xodim doim modellarni <b>4 ta fundamental arxetip</b> bo'yicha ajratadi:</p>\n  <div class=\"matrix-grid\">\n    <div class=\"matrix-col\">\n      <div style=\"font-size:10.5px; font-weight:800; color:var(--brand-emerald); text-transform:uppercase;\">1-Toifa: Frontier Generalists</div>\n      <b style=\"color:var(--text); font-size:13.5px;\">Claude 3.7 / 3.5 Sonnet & GPT-4o</b>\n      <p style=\"font-size:12px; color:var(--text-secondary); margin:4px 0 0 0;\">\n        <b>Vazifasi:</b> B2B hujjatlar, silliq rasmiy matnlar, tezkor kundalik marketing va multimodal (ovoz/rasm) ishlar. Har qanday ishchi stolining universal tayanchi.\n      </p>\n    </div>\n    <div class=\"matrix-col\">\n      <div style=\"font-size:10.5px; font-weight:800; color:#d97706; text-transform:uppercase;\">2-Toifa: Deep Reasoning (O'ylovchi)</div>\n      <b style=\"color:var(--text); font-size:13.5px;\">OpenAI o1 / o3-mini & DeepSeek-R1</b>\n      <p style=\"font-size:12px; color:var(--text-secondary); margin:4px 0 0 0;\">\n        <b>Vazifasi:</b> Murakkab mantiq, chuqur moliyaviy hisob-kitoblar va qiyin dasturlash. Javob berishdan oldin 5-30 soniya o'ylab (Chain-of-Thought), o'z xatosini o'zi tekshiradi.\n      </p>\n    </div>\n    <div class=\"matrix-col\">\n      <div style=\"font-size:10.5px; font-weight:800; color:var(--tg-blue); text-transform:uppercase;\">3-Toifa: Ulkan Kontekst (Massive Context)</div>\n      <b style=\"color:var(--text); font-size:13.5px;\">Google Gemini 2.0 Flash / Pro</b>\n      <p style=\"font-size:12px; color:var(--text-secondary); margin:4px 0 0 0;\">\n        <b>Vazifasi:</b> 1-2 million tokenlik xotira. 500-1000 betlik qalin kitoblar, yillik moliya arxivlari va butun korxona hisobotlarini bir martada tahlil qilish.\n      </p>\n    </div>\n    <div class=\"matrix-col\">\n      <div style=\"font-size:10.5px; font-weight:800; color:#6366f1; text-transform:uppercase;\">4-Toifa: Ochiq & Tejamkor (Open-Weights)</div>\n      <b style=\"color:var(--text); font-size:13.5px;\">DeepSeek-V3 & Llama 3.3</b>\n      <p style=\"font-size:12px; color:var(--text-secondary); margin:4px 0 0 0;\">\n        <b>Vazifasi:</b> Korxona ichki maxfiy serverlarida mustaqil ishlatish va 10 barobar arzon ommaviy CRM/Telegram avtomatlashtirish botlari.\n      </p>\n    </div>\n  </div>\n\n  <div class=\"notes-box\" style=\"margin-top:14px; background:rgba(5, 150, 105, 0.05); border-left:3px solid var(--brand-emerald); padding:10px 14px;\">\n    <b style=\"color:var(--brand-emerald); font-size:12px;\">💡 Qanday Qilib Har Doim To'g'ri Modelni Tanlash Mumkin? (Evergreen Qoida):</b>\n    <p style=\"font-size:12px; color:var(--text-secondary); margin:4px 0 0 0; line-height:1.5;\">\n      Kelajakda qanday yangi model chiqmasin (masalan, GPT-5 yoki Claude 4), uning versiya raqamiga emas, balki qaysi <b>toifaga</b> tegishli ekaniga qarang: Tezkor kundalik yozishma uchun — Generalist, chuqur tahlil va mantiq uchun — Reasoning, qalin kitoblar uchun — Massive Context modelini tanlang. Eng so'nggi xalqaro benchmarklarni doimiy kuzatish uchun esa <b>Chatbot Arena (lmsys.org)</b> reytingiga tayaning.\n    </p>\n  </div>\n  </div>\n\n  <div class=\"case-callout\" style=\"border-left-color:var(--lime); margin-top:20px;\">\n    <h4 style=\"color:var(--brand-emerald); margin-top:0;\">🏢 3-Qism: Real Korxona Misoli (Halutsinatsiya Falokati)</h4>\n    <p>\n      Toshkentdagi ulgurji savdo korxonasi xodimi ChatGPT bepul versiyasiga: <i>\"Yangi Soliq kodeksi bo'yicha keshbekka qanday chegirma beriladi?\"</i> deb ochiq savol berdi. Model O'zbekiston qonunida mavjud bo'lmagan soxta \"18-modda, 3-qism\"ni to'qib chiqardi. Natijada korxona shartnomada xato band kiritib, noqulay vaziyatga tushdi.\n    </p>\n    <p>\n      <b>To'g'ri GPTify Yondashuvi (Grounding):</b> Modelga hech qachon ochiq manbasiz savol bermang. Avval rasmiy hujjat matnini ko'chirib o'tkazing va buyruq bering: <i>\"Faqat quyidagi matn doirasida javob ber. Agar javob matnda bo'lmasa, 'Ushbu ma'lumot taqdim etilgan matnda yo'q' deb javob qaytar.\"</i>\n    </p>\n  </div>\n</div>",
    "quiz": {
    ...
    "notes": [
      ...
      "<b>4 Ta Asosiy Arxetip:</b> Generalist (Claude 3.7 / GPT-4o), Reasoning (o1 / o3-mini / DeepSeek-R1), Ulkan Kontekst (Gemini 2.0), Ochiq (DeepSeek-V3).",
  ...
  "3_1": {
    ...
    "notes": [
      "<b>Claude (3.7 / 3.5):</b> Chuqur tahlil, B2B hujjatlar va gibrid mulohaza ustasi.",
      "<b>ChatGPT (o-Series & 4o):</b> Ovozli muloqot, tezkor g'oyalar va multimodal vazifalar.",
      "<b>Perplexity & DeepSeek:</b> Jonli internet qidiruvi va tejamkor keng ko'lamli vazifalar."
    ],
